...
filename = os.path.join(mc_dir, "versions", ver_choosen, ver_choosen + ".json")

ver_json = json.load(open(filename))
...
new_filename = os.path.join(mc_dir, "versions", ver_choosen + "-fix_skin", ver_choosen + "-fix_skin" + ".json")
if not os.path.exists(new_folder): os.makedirs(new_folder)
json.dump(new_ver_json, open(new_filename, 'w'))
